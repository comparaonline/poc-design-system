...
import { ButtonUnstyled, SelectUnstyled, OptionUnstyled } from '@mui/base';
          ...
          <div className="flex justify-between pt-2">
            <div className="flex items-center space-x-5">
              <div className="flow-root">
                <SelectUnstyled value={selected} onChange={setSelected}>
                  <>
                    {' '}
                    {({ open }) => (
                      <>
                        <div className="relative">
                          <ButtonUnstyled className="relative -m-2 inline-flex h-10 w-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500">
